...
from hummingbot.strategy.custom_market_making import CustomMarketMakingStrategy, InventoryCostPriceDelegate
...
def start(self):
    ...
    try:
        ...
        strategy_logging_options = CustomMarketMakingStrategy.OPTION_LOG_ALL
        self.strategy = CustomMarketMakingStrategy()
