...
from .custom_market_making_order_tracker import CustomMarketMakingOrderTracker
...
cdef class CustomMarketMakingStrategy(StrategyBase):
    ...
    def init_params(self,
        ...
        self._sb_order_tracker = CustomMarketMakingOrderTracker()
